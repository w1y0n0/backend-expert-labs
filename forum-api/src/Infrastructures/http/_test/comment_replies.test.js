...
describe('/threads/{threadId}/comments/{commentId}/replies endpoint', () => {
    ...
    describe('when POST /threads/{threadId}/comments/{commentId}/replies', () => {
        it('should response 201 and persisted comment', async () => {
            ...
            const response = await server.inject({
                method: 'POST',
                url: `/threads/${myThread.id}/comments/${myComment.id}/replies`,
    ...
    describe('when DELETE /threads/{threadId}/comments/{commentId}/replies/{replyId}', () => {
        it('should response 200 and soft delete the comment', async () => {
            ...
            const response = await server.inject({
                method: 'DELETE',
                url: `/threads/${myThread.id}/comments/${myComment.id}/replies/${addedReply.id}`,
                headers: {
                    authorization: `Bearer ${myAccessToken}`
                }
            });
        ...
        it('should response 404 when on invalid comment', async () => {
            ...
            const response = await server.inject({
                method: 'DELETE',
                url: `/threads/${myThread.id}/comments/${myComment.id}/replies/${addedReply.id}xxx`,
                headers: {
                    authorization: `Bearer ${myAccessToken}`
                }
            });
